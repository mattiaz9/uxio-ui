...
function iconProps(className: string | undefined, props: IconProps) {
  const { className: cnProp, ...rest } = props
  return {
    className: cn("shrink-0 text-current", className, cnProp),
...
/** Vega — rounded square */
export function VegaThemeIcon({ className, ...props }: IconProps) {
  return (
...
/** Nova — vertical pill / stadium */
export function NovaThemeIcon({ className, ...props }: IconProps) {
  return (
    <svg {...iconProps(className, props)}>
      <path
...
/** Maia — circle */
export function MaiaThemeIcon({ className, ...props }: IconProps) {
  return (
    <svg {...iconProps(className, props)}>
      <circle cx={12} cy={12} r={10} stroke="currentColor" strokeWidth={2} strokeLinejoin="round" />
    </svg>
  )
}

/** Lyra — hex-style shield */
export function LyraThemeIcon({ className, ...props }: IconProps) {
  return (
    <svg {...iconProps(className, props)}>
      <path
...
/** Mira — diamond */
export function MiraThemeIcon({ className, ...props }: IconProps) {
  return (
    <svg {...iconProps(className, props)}>
      <path
...
/** Luma — horizontal capsule */
export function LumaThemeIcon({ className, ...props }: IconProps) {
  return (
    <svg {...iconProps(className, props)}>
      <path
