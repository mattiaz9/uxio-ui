...
<ComponentPreview name="radix/dialog-body" />

### Footer with border-t

Add `border-t` (and a border color such as `border-border`) on `DialogFooter` for a full-width muted
footer strip.

<ComponentPreview name="radix/dialog-footer-border" />
