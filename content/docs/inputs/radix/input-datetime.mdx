...
description:
  Date and time input with segmented editing, a hidden field for native forms, and optional calendar
  selection.
---
...
export function ScheduledAtField() {
  ...
  return <InputDatetime mode="datetime" value={value ?? undefined} onValueChange={setValue} />
}
```
