...
Use `size` so the field aligns with [`InputGroup`](/docs/overrides/base/input-group) and
[`Input`](/docs/overrides/base/input) dimensions. Segment padding and text scale with the group.
