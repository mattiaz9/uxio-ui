...
import {
  ...
  CommandItem,
  CommandList,
} from "@/registry/uxio/overrides-command-radix/command"
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
  ...
  return (
    <Popover open={open} onOpenChange={onOpenChange}>
      ...
      <PopoverContent
        ...
        className={cn(
          "cn-vercel-sidebar-search-popover z-50 flex w-(--radix-popover-trigger-width,min(20rem,calc(100vw-2rem))) max-w-[min(24rem,calc(100vw-1rem))] flex-col overflow-hidden border border-border bg-popover p-0 text-popover-foreground shadow-lg",
          className,
        )}
