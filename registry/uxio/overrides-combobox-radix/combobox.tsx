...
function Combobox({
  ...
  const [items, setItems] = React.useState(new Map<string, React.ReactNode>())
  ...
  return (
    <PopoverTrigger asChild>
      <Button
        ...
        className={cn(
          "cn-combobox-trigger flex w-fit items-center justify-between gap-2 overflow-hidden whitespace-nowrap",
          className,
        )}
      >
        {children}
